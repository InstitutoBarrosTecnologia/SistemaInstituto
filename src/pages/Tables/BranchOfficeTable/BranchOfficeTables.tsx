...
import FormBranchOffice from "../../Forms/BranchOffice/FormBranchOffice";
import BranchOfficeGrid from "../../../components/tables/BranchOfficeGrid/BranchOfficeGrid";


export default function BranchOfficeTables() {
    ...
    return (
        <>
            <PageMeta
                ...
                description="Sistema Instituto Barros - Página para gerenciamento de unidades"
            />

            <PageBreadcrumb pageTitle="Unidades Instituto Barros" />
            ...
            <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4">
                <FormBranchOffice closeModal={closeModal} />
            </Modal>

            <div className="space-y-6">
                <BranchOfficeGrid searchTerm={searchTerm} />
            </div>
