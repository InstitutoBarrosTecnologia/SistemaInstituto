            ...
            <div className="mb-2 flex h-11 rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring dark:border-gray-700 dark:bg-gray-900 dark:focus:border-brand-300">
              <div className="flex flex-auto gap-2 overflow-hidden">
                {selectedValuesText.length > 0 ? (
                  <>
                    {selectedValuesText.slice(0, 2).map((text, index) => (
                      <div
                        key={index}
                    ...
                    {selectedValuesText.length > 2 && (
                      <div className="flex items-center justify-center rounded-full border-[0.7px] border-transparent bg-gray-100 py-1 px-2.5 text-sm text-gray-800 dark:bg-gray-800 dark:text-white/90 flex-shrink-0">
                        <span className="text-xs">+{selectedValuesText.length - 2} mais</span>
                      </div>
                    )}
                  </>
                ) : (
